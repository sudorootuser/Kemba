<?php include '../Header/HeaderPopUp.php';
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body" style="text-align: center; align-items: center;">
                    ...
                    <br>
                    <br>
                    <p>Se ha registado de manera exitosa señor <?php echo $name; ?>, click en continuar para ir a la Navegación de la plataforma</p>
